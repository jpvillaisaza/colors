...
var $author$project$Main$Search = $elm$core$Basics$identity;
var $author$project$Search$init = {I: _List_Nil, N: ''};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			{J: key, D: $author$project$Search$init, R: url},
...
var $author$project$Color$Source$CMYK = 0;
var $author$project$Color$Source$Crayola = 1;
var $author$project$Color$Source$Munsell = 2;
var $author$project$Color$Source$NCS = 3;
var $author$project$Color$Source$Pantone = 4;
var $author$project$Color$Source$RGB = 5;
var $author$project$Color$blues = _List_fromArray(
	[
		{c: '#333399', a: 'blue', b: 0},
		{c: '#1f75fe', a: 'blue', b: 1},
		{c: '#0087bd', a: 'blue', b: 3},
...
var $author$project$Color$greens = _List_fromArray(
	[
		{c: '#00a550', a: 'green', b: 0},
		{c: '#1cac78', a: 'green', b: 1},
		{c: '#009f6b', a: 'green', b: 3},
		{c: '#00a877', a: 'green', b: 2},
		{c: '#00ad83', a: 'green', b: 4},
		{c: '#00ff00', a: 'green', b: 5}
	]);
var $author$project$Color$reds = _List_fromArray(
	[
		{c: '#ed1c24', a: 'red', b: 0},
		{c: '#ee204d', a: 'red', b: 1},
		{c: '#f2003c', a: 'red', b: 2},
...
var $author$project$Color$Source$toString = function (source) {
	switch (source) {
		case 0:
			return 'CMYK';
		case 1:
...
var $author$project$Color$search = function (q) {
	var contains = function (color) {
		return A2(
			...
			$elm$core$String$toLower(
				$author$project$Color$Source$toString(color.b)));
	};
	return $elm$core$String$isEmpty(q) ? _List_Nil : $elm$core$List$concat(
		_List_fromArray(
			[
				A2($elm$core$List$filter, contains, $author$project$Color$reds),
				A2($elm$core$List$filter, contains, $author$project$Color$greens),
				A2($elm$core$List$filter, contains, $author$project$Color$blues)
			]));
};
	...
	function (msg, model) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					I: $author$project$Color$search(q),
					N: q
				}),
			$elm$core$Platform$Cmd$none);
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _v1 = model.D;
				var search = _v1;
				var _v2 = A2($author$project$Search$update, searchMsg, search);
				var searchNew = _v2.a;
				var cmds = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$viewFooter = function (_v0) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('https://github.com/jpvillaisaza/colors')
					]),
				_List_fromArray(
					[
...
var $author$project$Search$Q = $elm$core$Basics$identity;
...
var $author$project$Color$viewColor = function (color) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'background-color', color.c),
...
var $author$project$Color$viewColors = function (colors) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'grid-template-columns', 'repeat(auto-fill, minmax(min(150px, 100%), 1fr))')
			]),
		A2($elm$core$List$map, $author$project$Color$viewColor, colors));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Color$viewColors(model.I)
			]));
};
		...
		_List_fromArray(
			[
				...
				return A2(
					...
					$author$project$Search$view(search));
			}()
			]));
};
var $author$project$Main$view = function (model) {
	...
	return {at: body, aG: 'Colors'};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{aA: $author$project$Main$init, aB: $author$project$Main$onUrlChange, aC: $author$project$Main$onUrlRequest, aF: $author$project$Main$subscriptions, aH: $author$project$Main$update, aI: $author$project$Main$view});
